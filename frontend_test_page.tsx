...
export default function HomePage() {
  ...
  useEffect(() => {
    // Attempt to connect to WebSocket when the component mounts
    connectWebSocket();
  ...
  const startRecording = async () => {
    ...
    try {
      ...
      // 5. Connect the nodes: microphone -> pcmProcessor
  ...
  const stopRecording = async () => {
    ...
    if (pcmProcessorNodeRef.current) {
      ...
      // pcmProcessorNodeRef.current.port.close(); // Not strictly needed if node is disconnected and context closed
    ...
    <div style={{ padding: \'20px\', fontFamily: \'Arial, sans-serif\' }}>
      ...
      <div style={{ marginTop: \'30px\', fontSize: \'0.9em\', color: \'#555\' }}>
        ...
        <p>
          ...
          The current <code>pcm-processor.js</code> <strong>does not perform resampling</strong>. 
          If the actual sample rate sent to Deepgram is not {TARGET_SAMPLE_RATE}Hz, transcription may fail or be inaccurate. 
